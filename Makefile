...
KBUILD_CFLAGS	+= -Ofast -fno-finite-math-only $(GRAPHITE)  -fmodulo-sched -fmodulo-sched-allow-regmoves -fsingle-precision-constant -fsched-pressure -fweb -fsched-spec-load -frename-registers -flimit-function-alignment
endif
